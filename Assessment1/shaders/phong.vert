...
out vec3 vs_position, vs_normal, vs_light_direction;
out vec4 vs_diffuse_colour;
...
void main()
{
	...
	vs_position = (model_view_matrix * position_homogeneous).xyz;
	...
	vs_light_direction = light_position - vs_position;			
